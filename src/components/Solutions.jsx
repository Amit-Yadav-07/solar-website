...
const solutions = [
  {
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 32 32" fill="none">
        <rect x="2" y="10" width="28" height="18" rx="3" fill="none" stroke="#10b981" strokeWidth="1.5" opacity="0.6" />
        <line x1="2" y1="19" x2="30" y2="19" stroke="#10b981" strokeWidth="1.5" opacity="0.4" />
        <line x1="16" y1="10" x2="16" y2="28" stroke="#10b981" strokeWidth="1.5" opacity="0.4" />
        <path d="M12 4 L16 2 L20 4" stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 32 32" fill="none">
        <rect x="1" y="8" width="30" height="20" rx="3" fill="none" stroke="#10b981" strokeWidth="1.5" />
        <line x1="1" y1="18" x2="31" y2="18" stroke="#10b981" strokeWidth="1.5" opacity="0.5" />
        <line x1="11" y1="8" x2="11" y2="28" stroke="#10b981" strokeWidth="1.5" opacity="0.5" />
        <line x1="21" y1="8" x2="21" y2="28" stroke="#10b981" strokeWidth="1.5" opacity="0.5" />
        <circle cx="16" cy="4" r="3" fill="#10b981" opacity="0.7" />
        <line x1="16" y1="7" x2="16" y2="8" stroke="#10b981" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 32 32" fill="none">
        <circle cx="16" cy="16" r="8" fill="none" stroke="#10b981" strokeWidth="1.5" />
        ...
        {[0, 45, 90, 135, 180, 225, 270, 315].map((d, i) => (
          <line key={i} x1={16 + 10 * Math.cos(d * Math.PI / 180)} y1={16 + 10 * Math.sin(d * Math.PI / 180)}
            ...
            stroke="#10b981" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
        ))}
      </svg>
    ),
  },
            ...
            <div key={i} className={`reveal rounded-2xl p-8 relative flex flex-col transition-all duration-300 hover:scale-[1.01]`}
              style={{
                background: s.popular
                  ? 'linear-gradient(135deg, rgba(16,185,129,0.2) 0%, rgba(16,185,129,0.2) 100%)'
                  : cardBg,
                border: s.popular ? '1px solid rgba(16,185,129,0.2)' : `1px solid ${cardBorder}`,
              }}>
              {s.badge && (
