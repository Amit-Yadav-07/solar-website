    ...
    <section id="whyus" ref={ref} className="py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {reasons.map((r, i) => (
            <div key={i} className="reveal glass-card p-7 group hover:border-blue-500/30 transition-all duration-300"
              style={{
        ...
        <div className="mt-16 reveal">
          <div className="rounded-2xl p-8 text-center"
            style={{ background: 'linear-gradient(135deg, rgba(10, 116, 172, 0.2) 0%, rgba(10, 116, 172, 0.2) 100%)', border: '1px solid rgba(245,158,11,0.2)' }}>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Transparency', 'Flexibility', 'Reliability', 'Sustainability'].map(v => (
                <span key={v} className="font-outfit font-semibold text-sm px-6 py-3 rounded-full border border-blue-500/30 text-blue-400 bg-blue-500/5">
                  {v}
                </span>
              ))}
            </div>
